        ...
        <div className=' flex flex-col justify-center item-center mt-[-40px] space-y-8'>
          ...
          <div className=' py-8 mx-20 rounded-lg shadow-xl'>
            ...
            <div className="flex justify-center item-center mt-8">
              <img src="whatsApp-3.png" alt="whatsApp-logo" className='w-[30px] sm:w-[50px]' />
            ...
            <div className="flex justify-center item-center mt-2">
              <img src="call-3.png" alt="calling-logo" className='w-[30px] sm:w-[50px]' />
